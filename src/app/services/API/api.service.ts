...
export class APIService implements OnDestroy, OnInit {
  ...
  // async analyzeEssay(essayText: string): Promise<string> {
  //   if (essayText.trim()) {
  //     const prompt = `Act as a teacher and Analyze this essay: ${essayText}. Give a score to the essay; the maximum score is 10. Give me the score first, followed by strengths, areas for improvement, and recommendations for improvements. If the user's prompt is not an essay, please output "This is not an essay, give me an essay".`;
  ...
  //       return text.includes("This is not an essay, give me an essay")
  //         ? 'This is not an essay, give me an essay'
  //         : text;
  //     } catch (error) {
  ...
  //     }
  //   } else {
  //     throw new Error('Please enter an essay to analyze.');
  //   }
  // }
  ...
  createCourse(
    ...
    const postObject = {
      ...
      values: {
        ...
        Image: imageUrl,
        Objectives: courseObjectives,
        Target_Audience: `{${formattedTargetAudience}}`,  // Correct format for PostgreSQL TEXT[]
        Technical_Requirements: `{${formattedTechRequirements}}`  // Correct format for PostgreSQL TEXT[]
      },
    };
